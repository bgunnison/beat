...
if not exist "%SRC_RELEASE%\Contents\x86_64-win\Beat.vst3" (
  echo Release package incomplete: missing %SRC_RELEASE%\Contents\x86_64-win\Beat.vst3
  goto :done
)

if not exist "%SRC_RELEASE%\Contents\Resources\beat.uidesc" (
  echo Release package incomplete: missing %SRC_RELEASE%\Contents\Resources\beat.uidesc
  goto :done
)
